# Generated by Django 3.0.7 on 2020-06-24 12:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('work_status', models.CharField(choices=[('seeking', 'seeking'), ('inactive', 'inactive'), ('in transit', 'in transit')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('request_status', models.CharField(choices=[('new', 'new'), ('accepted', 'accepted'), ('complete', 'complete')], max_length=50)),
